...
static void SwapGdiPlusBitmap(CGdiPlusBitmap& lhs, CGdiPlusBitmap& rhs)
{
    Gdiplus::Bitmap* p_temp_bitmap = lhs.m_pBitmap;
    lhs.m_pBitmap = rhs.m_pBitmap;
    rhs.m_pBitmap = p_temp_bitmap;
}
